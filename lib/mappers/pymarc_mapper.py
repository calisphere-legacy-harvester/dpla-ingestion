...
class PYMARCMapper(Mapper):
    '''Class for reading MARC json records generated by pymarc.
    These have a very different structure from the DPLA marc reader.
    '''
    ...
    def __init__(self, provider_data, key_prefix=None,
        ...
        super(PYMARCMapper, self).__init__(provider_data, key_prefix)

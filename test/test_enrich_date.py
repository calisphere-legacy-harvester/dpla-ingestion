...
def test_enrich_pre_1900_date():
    ...
    INPUT = {"date": "1870-01-02T12:00:00"}
    EXPECTED = {
        u'date': [{
            'begin': u'1870-01-02',
            'end': u'1870-01-02',
...
def test_range_years_with_brackets():
    ...
    ranges = [
        "[1960 - 1963]", "[ 1960 - 1963 ]", "[1960 / 1963]", "[ 1960 / 1963 ]"
    ]
...
def test_enrich_date_parse_format_date_range2():
    ...
    INPUT = {"date": "1960-05-01 - 1960-05-15"}
    EXPECTED = {
        u'date': [{
            u'begin': u'1960-05-01',
            u'end': u'1960-05-15',
...
def test_enrich_date_parse_format_date_range4():
    ...
    result = json.loads(content)
    assert result['date'] == EXPECTED[u'date'], "%s != %s" % (
        result['date'], EXPECTED[u'date'])
...
def test_enrich_date_date_parse_format_natural_string_for_multiple_dates():
    """Correctly transform a date of format Month, DD, YYYY"""
    INPUT = {"date": "May 20, 1928; 2002-01-01"}
    EXPECTED = {
        'date': [{
            'begin': u'1928-05-20',
            'end': u'1928-05-20',
...
def test_dates_with_question_marks():
    ...
    INPUT = [
        "1928?", "1928? - 1929?", "1928?/1929?", "1928? / 1929?",
        "1928? - 1929", "1928 - 1929?"
    ]
    EXPECTED = [{
        "begin": "1928",
...
def test_bogus_date():
    ...
    INPUT = [
        "abcdef", "a-bcdef", "a - bcdef", "a-bcde-f", "a - bcde - f",
...
def test_dates_with_between():
    INPUT = ["between 1840 and 1860", "between 1860 and 1840"]
    url = server() + "enrich_earliest_date?prop=date"
    for i in range(len(INPUT)):
        input = {"date": INPUT[i]}
        expected = {
...
def test_tricky_dates1():
    ...
    INPUT = [
        "ca. 1850 - c 1856", "c 1850 - 1856", " 1850 c. - c.1856 ",
...
def test_tricky_dates2():
    ...
    INPUT = [
        "1938-08-23/24", "1938-08-23-24", "1938/08/23-24", "1938/08/23/24"
    ]
...
def test_year_month():
    ...
    INPUT = [
        "1940/2", "1940/02", "1940 / 2", "1940 / 02", "1940-2", "1940-02",
        "1940 - 2", "1940 - 02", "2/1940", "02/1940", "2 / 1940", "02 / 1940",
...
def test_delim_with_months():
    ...
    INPUT = [
        "2004 July/August", "July/August 2004", "2004 July-August",
        "July-August 2004"
    ]
...
def test_delim_with_seasons():
    ...
    INPUT = [
        "2004 Fall/Winter", "Fall/Winter 2004", "2004 Fall-Winter",
        "Fall-Winter 2004"
    ]
